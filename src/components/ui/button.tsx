  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[opacity,transform,background-color,color] duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/50 disabled:pointer-events-none disabled:opacity-40 active:scale-[0.98] [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-elevated text-fg hover:bg-fill",
        ghost: "text-accent hover:bg-elevated",
        outline: "bg-transparent text-accent shadow-[inset_0_0_0_1px_var(--color-border)]",
        live: "bg-live text-live-fg hover:opacity-90",
        danger: "text-live hover:bg-live/10",
        plain: "text-fg hover:bg-elevated",
      },
      size: {
        default: "h-11 px-4",
        sm: "h-9 px-3 text-xs",
